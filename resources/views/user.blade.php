        ...
        <table class="table-auto border border-gray-400 border-collapse w-full">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="border border-gray-400 px-4 py-2">Asep</td>
                    <td class="border border-gray-400 px-4 py-2">asep@example.com</td>
                    <td class="border border-gray-400 px-4 py-2">081234567890</td>
