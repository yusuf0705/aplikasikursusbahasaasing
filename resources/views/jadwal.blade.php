        ...
        <div class="overflow-x-auto">
            ...
            <thead>
                <tr class="bg-gray-100">
                    ...
                    <th class="border border-gray-400 px-4 py-2">Id_kursus</th>
                    <th class="border border-gray-400 px-4 py-2">hari</th>
                    <th class="border border-gray-400 px-4 py-2">Jam Mulai</th>
                    <th class="border border-gray-400 px-4 py-2">Jam selesai</th>
                    <th class="border border-gray-400 px-4 py-2">Metode Pembelajaran</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="border border-gray-400 px-4 py-2">Senin</td>
                    <td class="border border-gray-400 px-4 py-2">18.00</td>
                    <td class="border border-gray-400 px-4 py-2">20.00</td>
                    <td class="border border-gray-400 px-4 py-2">Offline</td>
                    <td class="border border-gray-400 px-4 py-2 space-x-2">
                        <button class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded text-sm">Edit</button>
                        <button class="bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded text-sm">Hapus</button>
                    </td>
