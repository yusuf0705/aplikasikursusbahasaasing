        ...
        <div class="overflow-x-auto">
            ...
            <thead>
                <tr class="bg-gray-100">
                    ...
                    <th class="border border-gray-400 px-4 py-2">Pertanyaan</th>
                    <th class="border border-gray-400 px-4 py-2">opsi</th>
                    <th class="border border-gray-400 px-4 py-2">Jawaban</th>
                    <th class="border border-gray-400 px-4 py-2">Aksi</th> <!-- Posisi header Aksi -->
                </tr>
            </thead>
            <tbody>
                <!-- <tr>
                    ...
                    <td class="border border-gray-400 px-4 py-2">Grammar_1</td>
                    <td class="border border-gray-400 px-4 py-2">ini grammar 1</td>
                    <td class="border border-gray-400 px-4 py-2">link materi</td>
                    <td class="border border-gray-400 px-4 py-2 space-x-2">
                        <button class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded text-sm">Edit</button>
                ...
                <tr>
                    ...
                    <td class="border border-gray-400 px-4 py-2">apa yang di maksud</td>
                    <td class="border border-gray-400 px-4 py-2">
                        <button class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded text-sm">a</button>
                        <button class="bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded text-sm">b</button>                      
                        <button class="bg-green-500 hover:bg-green-600 text-white px-3 py-1 rounded text-sm">c</button>                       
                        <button class="bg-gray-500 hover:bg-gray-600 text-white px-3 py-1 rounded text-sm">d</button>
                    </td>
                    <td class="border border-gray-400 px-4 py-2">jawaban</td>
                    <td class="border border-gray-400 px-4 py-2 space-x-2">
                        <button class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded text-sm">Edit</button>
                        <button class="bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded text-sm">Hapus</button>
                    </td>
